...
function InitDatabase(){
    ...
    ExecuteFileQuery -filePath $(Join-Path -Path $curPath -ChildPath "ReadCommittedSnapshot\Examples\ReadCommittedSnapshotON\Powershell\Resources\CreateDatabase.sql") 
    ExecuteFileQuery -filePath $(Join-Path -Path $curPath -ChildPath "ReadCommittedSnapshot\Examples\ReadCommittedSnapshotON\Powershell\Resources\CreateObjects.sql") -dbName $dbName
    ExecuteFileQuery -filePath $(Join-Path -Path $curPath -ChildPath "ReadCommittedSnapshot\Examples\ReadCommittedSnapshotON\Powershell\Resources\InsertData.sql") -dbName $dbName
}
