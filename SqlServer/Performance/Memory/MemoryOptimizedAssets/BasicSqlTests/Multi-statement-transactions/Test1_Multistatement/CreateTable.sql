...
GO
CREATE PROCEDURE dbo.CreateSampleData2 @IsHeap BIT AS
...
(
	...
	CONSTRAINT pk_schema_only PRIMARY KEY NONCLUSTERED(ID DESC)
...
(
	...
	CONSTRAINT pk_schema_and_data PRIMARY KEY NONCLUSTERED(ID DESC)
...
(
	...
	CONSTRAINT pk_disk_based PRIMARY KEY NONCLUSTERED(ID)
)
